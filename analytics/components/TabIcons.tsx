...
export function TrendIcon() {
  return (
    <Svg>
      <path d="M3.5 15.5l4.5-5 3 3 5.5-6.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M13.5 6.5h3.5V10" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
...
export function MapPinIcon() {
  return (
    <Svg>
      <path
        d="M11 18.5s6-5.4 6-10a6 6 0 10-12 0c0 4.6 6 10 6 10z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
